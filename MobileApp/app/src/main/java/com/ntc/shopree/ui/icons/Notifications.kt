...
val NotificationsOutlined: ImageVector
    get() {
        if (_NotificationsOutlined != null) {
            return _NotificationsOutlined!!
        }
        _NotificationsOutlined = ImageVector.Builder(
...
@Suppress("ObjectPropertyName")
private var _NotificationsOutlined: ImageVector? = null
