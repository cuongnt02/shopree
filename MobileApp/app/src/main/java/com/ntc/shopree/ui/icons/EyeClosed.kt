...
val EyeClosedOutlined: ImageVector
    get() {
        if (_EyeClosedOutlined != null) {
            return _EyeClosedOutlined!!
        }
        _EyeClosedOutlined = ImageVector.Builder(
            name = "EyeClosedOutlined",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
            viewportHeight = 960f
...
private var _EyeClosedOutlined: ImageVector? = null

val EyeClosedFilled: ImageVector
    get() {
        if (_EyeClosedFilled != null) {
            return _EyeClosedFilled!!
        }
        _EyeClosedFilled = ImageVector.Builder(
...
@Suppress("ObjectPropertyName")
private var _EyeClosedFilled: ImageVector? = null
