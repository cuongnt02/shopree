...
interface ProductService {
    ...
    fun getVendorProduct(userId: UUID, productId: UUID): VendorProductResponse
    ...
    fun uploadProductImage(userId: UUID, productId: UUID, inputStream: InputStream, contentType: String, size: Long, altText: String?): ProductImageResponse
    fun uploadVariantImage(userId: UUID, productId: UUID, variantId: UUID, inputStream: InputStream, contentType: String, size: Long, altText: String?): ProductVariantResponse
    fun deleteProductImage(userId: UUID, productId: UUID, imageId: UUID)
    fun getProductImages(userId: UUID, productId: UUID): List<ProductImageResponse>
}